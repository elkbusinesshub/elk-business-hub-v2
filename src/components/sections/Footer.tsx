...
const socials = [
  { label: "LinkedIn",  href: "https://www.linkedin.com/in/elk-businesshub-97736b419",                             icon: "in" },
  { label: "Instagram", href: "https://www.instagram.com/elkcompany2024?igsh=a2s4dTVpbmQ0amNm",          icon: "ig" },
  { label: "Threads",   href: "https://www.threads.com/@elkcompany2026",                                 icon: "th" },
            ...
            {socials.map((s) => (
              ...
              >
                {s.icon === "wa" ? (
                  ...
                  <img src="/threads-logo.svg" alt="" width={16} height={16} aria-hidden="true" />
                ) : (
                  s.icon
                )}
              </a>
